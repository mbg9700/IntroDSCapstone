...
mermaid("
        ...
        C-->D(TEXT ANALYSIS <br> ID frequent terms in COD*, address fields)
        D-->E(SUBSET DEATHS OCCURRING IN KING CO.)
        E-->F(SAMPLE SELECTION <br> random, n=1,200)
        G(HOMELESS DEATH 2003-17)-->H(CLEAN )
        H-->I(LINK HOMELESS & DEATH CERTS. <br> add death cert. variables <br> to homeless reg. data)
        E-->I
        I-->J(APPEND 'HOMELESS' & 'WITH HOME' <br> including variable with homeless status <br> of each record)
        E-->J
        J-->K{EDA}
...
####  __ 1. Data cleaning and standardization __
...
####  __ 2. Homeless decedents - linking homeless death data to their death certificates __
...
####  2.  __Deriving new features in preparation for exploratory data analysis
...
####  4.  __Creating combined dataset for exploratory data analysis__
...
#### 6.__Unintentional injury sub-groups__
...
#### 7.__Substance abuse sub-groups__
